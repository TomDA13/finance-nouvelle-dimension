document.addEventListener('DOMContentLoaded', function() {
    ...
    if (signupBtn || heroSignupButton || ctaSignupButton) {
        const footerSignupButton = document.getElementById('footerSignupBtn');
        const signupButtons = [signupBtn, heroSignupButton, ctaSignupButton, footerSignupButton].filter(button => button !== null);
